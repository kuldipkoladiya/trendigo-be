...
export async function getProductCategoriesList(filter, options = {}) {
  const productCategories = await ProductCategories.find(filter, options.projection, options);
  return productCategories;
}
...
export async function createProductCategories(body, options = {}) {
